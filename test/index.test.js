        ...
        it('it should deny a user that does not exist', done => {
            chai.request(app)
                ...
                .end((err, res) => {
                    ...
                    res.body.should.be.a('object')
                    res.body.should.have.property('response').eql('failure')
        ...
        it('it should respond with the contentId and rating of a content that exists', done => {
            chai.request(app)
                ...
                .end((err, res) => {
                    ...
                    res.body.should.be.a('object')
                    res.body.should.have.property('response').eql('success')
                    res.body.should.have.property('contentId').eql(1)
                    res.body.should.have.property('rating').eql(3)
                    done()
                })
        })
    ...
    describe('GET /content', () => {
        it('it should respond with a list of content (no matter what as there is no input)', done => {
            chai.request(app)
                ...
                .end((err, res) => {
                    res.should.have.status(200)
                    res.body.should.have.property('content').be.a('array')
                    done()
                })
        })
    })
